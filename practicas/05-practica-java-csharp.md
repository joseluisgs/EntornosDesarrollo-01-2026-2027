## **Actividad de Investigación: Comparativa de Lenguajes - Java, C#, Python y TypeScript**

### **Objetivo de la Actividad**

Comprender y analizar en profundidad el proceso de compilación y ejecución de cuatro lenguajes de programación modernos (Java, C#, Python y TypeScript), identificando las similitudes y diferencias clave que explican su rendimiento, su capacidad multiplataforma y su paradigma de uso.
